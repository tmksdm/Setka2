...
export const changelog = [
  {
    ...
    date: '15.03.2026',
    changes: [
      'EditClientPage: экран редактирования клиента с загрузкой данных из Firestore',
      'Статусный баннер с цветом, иконкой и информацией о днях/заморозке',
      'Кнопки действий: Продлить, Заморозить, История (заглушки для шагов 11/12/14)',
      'Форма редактирования: имя, телефон, заметка, тариф, сумма, дни, дата',
      'Удаление клиента с подтверждением',
      'Архивирование клиента с подтверждением',
      'Кнопка «Сохранить» активна только при наличии изменений',
      'App.tsx: навигация main → editClient по клику на карточку',
      'MainPage: проп onNavigateToEditClient для перехода к редактированию',
    ],
  },
    {
    version: '260315.7',
